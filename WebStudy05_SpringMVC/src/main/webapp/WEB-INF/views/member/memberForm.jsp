...
<!--       			accept =>이미지 파일만 입력할 수 있도록 제한 -->
      ...
      <tr>
         <th>생일</th>
         <td><form:input type="date" path="memBir" class="form-control" required="true" />
         <form:errors path="memBir" element="span" cssClass="error" /></td>
      </tr>
      <tr>
         <th>우편번호</th>
         <td><form:input path="memZip" class="form-control" required="true" />
         <form:errors path="memZip" element="span" cssClass="error" /></td>
      </tr>
      <tr>
         <th>주소1</th>
         <td><form:input path="memAdd1" class="form-control" required="true" />
         <form:errors path="memAdd1" element="span" cssClass="error" /></td>
      </tr>
      <tr>
         <th>주소2</th>
         <td><form:input path="memAdd2" class="form-control" required="true" />
         <form:errors path="memAdd2" element="span" cssClass="error" /></td>
      </tr>
      <tr>
         <th>집전번</th>
         <td><form:input path="memHometel" class="form-control" required="true" />
         <form:errors path="memHometel" element="span" cssClass="error" /></td>
      </tr>
      <tr>
         <th>회사전번</th>
         <td><form:input path="memComtel" class="form-control" required="true" />
         <form:errors path="memComtel" element="span" cssClass="error" /></td>
      </tr>
      <tr>
         <th>휴대폰</th>
         <td><form:input path="memHp" class="form-control" required="true" />
         <form:errors path="memHp" element="span" cssClass="error" /></td>
      </tr>
      <tr>
         <th>이메일</th>
         <td><form:input path="memMail" class="form-control" required="true" />
         <form:errors path="memMail" element="span" cssClass="error" /></td>
      </tr>
      <tr>
         <th>직업</th>
         <td><form:input path="memJob" class="form-control" required="true" />

 ...
 * Principal 객체를 생성하고, 현재 요청을 변경하여 principal을 setting 하려함(Adapter[Wraaper] request)
 *
 */
@Slf4j
public class GeneratePrincipalFilter implements Filter{
	// 한 사람의 회원에 대한 정보를 표현하고 있는 memberVO -> principal로 만들것인가?
//			memberVO를 직접 principal로 바꾸면 퍼블리싱 다시 해야함 -> adapter패턴 사용
	@Override

 ...
 * Generated at: 2023-09-11 02:51:03 UTC
...
public final class formUI_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<div>\r\n");
      out.write("	<h4>request content type</h4>\r\n");
      out.write("	<input type=\"radio\" name=\"contentType\" data-content-type=\"application/json;charset=UTF-8\" />JSON\r\n");
      out.write("	<input type=\"radio\" name=\"contentType\" checked/>PARAMETER\r\n");
      out.write("</div>\r\n");
      out.write("<div>\r\n");
      out.write("	<h4>response content type</h4>\r\n");
      out.write("	<input type=\"radio\" name=\"dataType\" data-data-type=\"json\" data-success=\"jsonSuccess\" />JSON\r\n");
      out.write("	<input type=\"radio\" name=\"dataType\" data-data-type=\"xml\" data-success=\"xmlSuccess\" />XML\r\n");
      out.write("	<input type=\"radio\" name=\"dataType\" data-data-type=\"html\" data-success=\"htmlSuccess\" checked/>HTML\r\n");
      out.write("</div>\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/09/model2/formDataProcess\" method=\"post\" enctype=\"application/x-www-form-urlencoded\">\r\n");
      out.write("<pre> \r\n");
      ...
      out.write("	let functionObj = {\r\n");
      out.write("			jsonSuccess : function(resp){\r\n");
      out.write("				$resultArea.html(resp.message);\r\n");
      out.write("			},\r\n");
      out.write("			xmlSuccess : function(resp){\r\n");
      out.write("				let msg = $(resp).find(\"message\").text();\r\n");
      out.write("				$resultArea.html(msg);\r\n");
      out.write("			},\r\n");
      out.write("			htmlSuccess : function(resp){\r\n");
      ...
      out.write("		};\r\n");
      out.write("		\r\n");
      out.write("		let contentType = $(\"[name=contentType]:checked\").data(\"contentType\");\r\n");
      out.write("		let data = null;\r\n");
      out.write("		if(contentType){\r\n");
      out.write("			// json payload 전송 - Content-Type : application/json; charset=UTF-8\r\n");
      out.write("			settings.contentType = contentType;\r\n");
      out.write("			// marshalling\r\n");
      out.write("			data = JSON.stringify($form.serializeJSON());\r\n");
      out.write("		}else{\r\n");
      out.write("			// parameter 전송 - Content-Type : application/x-www-form-urlencoded (default - 생략가능)\r\n");
      out.write("			data = $form.serialize();\r\n");
      out.write("		}\r\n");
      out.write("		settings.data = data;\r\n");
      out.write("		\r\n");
      out.write("		let $dataType = $(\"[name=dataType]:checked\");\r\n");
      out.write("		settings.dataType = $dataType.data(\"dataType\");\r\n");
      out.write("		let fnName = $dataType.data(\"success\");\r\n");
      out.write("		settings.success = functionObj[fnName];\r\n");
      out.write("		\r\n");
      out.write("		\r\n");
      out.write("		\r\n");
